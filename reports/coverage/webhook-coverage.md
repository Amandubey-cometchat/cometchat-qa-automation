...
_Generated 2026-09-10T12:16:36.968Z from `src/registry/webhook.registry.ts`, cross-referenced with the latest local test run per environment._
...
| MESSAGE | message_sent | REST | PASSED | PASSED | AUTOMATED (not in last run) | FAILED |
| MESSAGE | message_edited | REST | PASSED | PASSED | AUTOMATED (not in last run) | FAILED |
| MESSAGE | message_deleted | REST | FAILED | PASSED | AUTOMATED (not in last run) | FAILED |
...
| MESSAGE | message_delivery_receipt | SDK | PASSED | PASSED | AUTOMATED (not in last run) | PASSED |
| MESSAGE | message_read_receipt | SDK | PASSED | PASSED | AUTOMATED (not in last run) | PASSED |
| MESSAGE | message_delivered_to_all | SDK | PASSED | PASSED | AUTOMATED (not in last run) | PASSED |
| MESSAGE | message_read_by_all | SDK | PASSED | PASSED | AUTOMATED (not in last run) | PASSED |
...
| CALLS | call_initiated | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | PASSED |
| CALLS | call_unanswered | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | PASSED |
| CALLS | call_cancelled | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | PASSED |
| CALLS | call_rejected | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | PASSED |
| CALLS | call_busy | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | FAILED |
| CALLS | call_started | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | FAILED |
| CALLS | call_participant_joined | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | FAILED |
| CALLS | call_participant_left | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | FAILED |
| CALLS | call_ended | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | FAILED |
| MEETINGS | meeting_started | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | FAILED |
| MEETINGS | meeting_participant_joined | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | FAILED |
| MEETINGS | meeting_participant_left | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | FAILED |
| MEETINGS | meeting_ended | SDK | PASSED | BLOCKED | AUTOMATED (not in last run) | FAILED |
...
| CAMPAIGN | after_notification_created | REST | BLOCKED | BLOCKED | FAILED | BLOCKED |
| CAMPAIGN | after_feed_item_sent | REST | BLOCKED | BLOCKED | FAILED | BLOCKED |
| CAMPAIGN | after_feed_item_delivered | REST | BLOCKED | BLOCKED | FAILED | BLOCKED |
| CAMPAIGN | after_feed_item_read | REST | BLOCKED | BLOCKED | FAILED | BLOCKED |
| CAMPAIGN | after_campaign_completed | REST | BLOCKED | BLOCKED | FAILED | BLOCKED |
...
| USER | user_connection_status_changed | SDK | PASSED | PASSED | AUTOMATED (not in last run) | PASSED |
| MODERATION | moderation_engine_blocked | REST | PASSED | FAILED | AUTOMATED (not in last run) | FAILED |
| MODERATION | moderation_engine_approved | REST | PASSED | FAILED | AUTOMATED (not in last run) | FAILED |
...
| LEGACY | before_message | REST | AUTOMATED (not in last run) | NOT_IMPLEMENTED | AUTOMATED (not in last run) | AUTOMATED (not in last run) |
